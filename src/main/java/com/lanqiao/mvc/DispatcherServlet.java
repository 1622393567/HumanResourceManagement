...
import com.lanqiao.ioc.BeanFactory;
...
public class DispatcherServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        controllerMapping = (Map<String, ControllerMapping>) config.getServletContext().getAttribute("com.lanqiao.controller");
        /*
        对HashMap进行遍历
         */
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (returnValue != null && returnValue instanceof String) { //方法返回的是一个字符串类//需要跳转页面
